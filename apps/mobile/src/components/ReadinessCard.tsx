  ...
  return (
    ...
    >
      <View style={{ flexDirection: "row", alignItems: "baseline", gap: 8 }}>
        <Text style={{ flex: 1, fontSize: 13, fontWeight: "700", color: colors.textDim }}>{label}</Text>
        <Text style={{ fontSize: 26, fontWeight: "800", color: colors.textBright }}>
          {pct}
      ...
      <Text style={{ fontSize: 11, lineHeight: 16, color: colors.textFaint }}>
