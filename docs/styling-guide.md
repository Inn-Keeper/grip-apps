...
**Never hardcode values.** Always use tokens from `@grip-apps/core/tokens`:
...
```tsx
import { space } from "@grip-apps/core/tokens";
...
```tsx
import { font } from "@grip-apps/core/tokens";
...
```tsx
import { radius } from "@grip-apps/core/tokens";
